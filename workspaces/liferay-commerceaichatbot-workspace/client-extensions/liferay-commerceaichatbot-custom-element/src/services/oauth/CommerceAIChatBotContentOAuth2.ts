...
export default class CommerceAIChatBotContentOAuth2 extends OAuth2Client {
	constructor() {
		super('liferay-commerceaichatbot-etc-spring-boot-oaua');
	}
	...
	async generate(data: any) {
		return this.fetch('/commerce/ai/chat', {
			body: JSON.stringify({
				...data,
