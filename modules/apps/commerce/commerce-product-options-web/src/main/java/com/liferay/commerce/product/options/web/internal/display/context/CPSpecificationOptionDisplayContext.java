...
public class CPSpecificationOptionDisplayContext
	...
	public String getApiURL(CPSpecificationOption cpSpecificationOption) {
		long cpSpecificationOptionId = (cpSpecificationOption == null) ? 0 :
			cpSpecificationOption.getCPSpecificationOptionId();

		return "/o/headless-commerce-admin-catalog/v1.0/specifications/" +
			cpSpecificationOptionId + "/list-type-definitions";
	}
