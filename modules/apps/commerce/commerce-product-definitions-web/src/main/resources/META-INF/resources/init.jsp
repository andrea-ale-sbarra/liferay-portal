...
page import="com.liferay.commerce.product.definitions.web.internal.display.context.CPDefinitionPricingClassDisplayContext" %><%@
...
page import="com.liferay.commerce.product.model.CPInstanceConstants" %><%@
