...
public class CPDVirtualSettingFileEntryServiceHttp {
	...
	public static com.liferay.portal.kernel.repository.model.FileEntry
			addFileEntry(
				HttpPrincipal httpPrincipal, long groupId, String serviceName,
				long folderId, java.io.InputStream inputStream, String fileName,
				String mimeType)
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, serviceName, folderId, inputStream,
				fileName, mimeType);
	...
	private static final Class<?>[] _addFileEntryParameterTypes0 = new Class[] {
		long.class, String.class, long.class, java.io.InputStream.class,
