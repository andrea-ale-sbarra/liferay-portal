 ...
 */
public class NoSuchVirtualOrderItemFileEntryException extends NoSuchModelException {
	...
	public NoSuchVirtualOrderItemFileEntryException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
