...
public class CProductSystemObjectDefinitionManager
	...
	public BaseModel<?> deleteBaseModel(BaseModel<?> baseModel)
		...
		return _cProductLocalService.deleteCProduct((CProduct)baseModel);
	}
	...
	public List<ObjectField> getObjectFields() {
		return Arrays.asList(
			...
			new TextObjectFieldBuilder(
				...
				createLabelMap("cp-definition-id")
			).name(
				"cpDefinitionId"
			).system(
				true
	...
	public Column<?, Long> getPrimaryKeyColumn() {
		return CProductTable.INSTANCE.CProductId;
	}
	...
	public void updateBaseModel(
		...
		productResource.patchProduct(primaryKey, _toProduct(values));
