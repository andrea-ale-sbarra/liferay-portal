...
public class CPDefinitionOptionRelServiceHttp {
	...
	public static java.util.Map<Long, java.util.List<Long>>
		...
		try {
			MethodKey methodKey = new MethodKey(
				CPDefinitionOptionRelServiceUtil.class,
				"getCPDefinitionOptionRelCPDefinitionOptionValueRelIds",
				_getCPDefinitionOptionRelCPDefinitionOptionValueRelIdsParameterTypes5);
	...
	public static java.util.Map<String, java.util.List<String>>
		...
		try {
			MethodKey methodKey = new MethodKey(
				CPDefinitionOptionRelServiceUtil.class,
				"getCPDefinitionOptionRelKeysCPDefinitionOptionValueRelKeys",
				_getCPDefinitionOptionRelKeysCPDefinitionOptionValueRelKeysParameterTypes6);
	...
	public static int getCPDefinitionOptionRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CPDefinitionOptionRelServiceUtil.class,
				"getCPDefinitionOptionRelsCount",
				_getCPDefinitionOptionRelsCountParameterTypes11);
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult
		...
		try {
			MethodKey methodKey = new MethodKey(
				CPDefinitionOptionRelServiceUtil.class,
				"searchCPDefinitionOptionRels",
				_searchCPDefinitionOptionRelsParameterTypes12);
	...
	public static int searchCPDefinitionOptionRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_searchCPDefinitionOptionRelsCountParameterTypes13);
	...
	public static com.liferay.commerce.product.model.CPDefinitionOptionRel
		...
		try {
			MethodKey methodKey = new MethodKey(
				CPDefinitionOptionRelServiceUtil.class,
				"updateCPDefinitionOptionRel",
				_updateCPDefinitionOptionRelParameterTypes15);
	...
	private static final Class<?>[]
		_deleteCPDefinitionOptionRelParameterTypes1 = new Class[] {long.class};
	private static final Class<?>[] _fetchCPDefinitionOptionRelParameterTypes2 =
		new Class[] {long.class};
	private static final Class<?>[] _fetchCPDefinitionOptionRelParameterTypes3 =
		new Class[] {long.class, long.class};
	private static final Class<?>[] _getCPDefinitionOptionRelParameterTypes4 =
		new Class[] {long.class};
	private static final Class<?>[]
		_getCPDefinitionOptionRelCPDefinitionOptionValueRelIdsParameterTypes5 =
	...
	private static final Class<?>[]
		_getCPDefinitionOptionRelsCountParameterTypes11 = new Class[] {
			long.class, boolean.class
		};
	private static final Class<?>[]
		_searchCPDefinitionOptionRelsParameterTypes12 = new Class[] {
			long.class, long.class, long.class, String.class, int.class,
			int.class, com.liferay.portal.kernel.search.Sort[].class
		};
	private static final Class<?>[]
		_searchCPDefinitionOptionRelsCountParameterTypes13 = new Class[] {
			long.class, long.class, long.class, String.class
		};
	private static final Class<?>[]
		_updateCPDefinitionOptionRelParameterTypes14 = new Class[] {
			long.class, long.class, java.util.Map.class, java.util.Map.class,
	...
	private static final Class<?>[]
		_updateCPDefinitionOptionRelParameterTypes15 = new Class[] {
			long.class, long.class, java.util.Map.class, java.util.Map.class,
			String.class, String.class, double.class, boolean.class,
