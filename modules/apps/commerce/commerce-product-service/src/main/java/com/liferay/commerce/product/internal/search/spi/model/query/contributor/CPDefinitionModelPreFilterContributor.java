...
public class CPDefinitionModelPreFilterContributor
	...
	private void _filterByAccountExcludedProducts(BooleanFilter booleanFilter, SearchContext searchContext){

		long[] excludedProductIds = GetterUtil.getLongValues(
			searchContext.getAttribute("commerceAccountExcludedProductIds"), null);
	...
	private void _filterByAccountExcludedCategories(BooleanFilter booleanFilter, SearchContext searchContext){

		long[] excludedCatogoriesIds = GetterUtil.getLongValues(
			searchContext.getAttribute("commerceAccountExcludedCategoriesIds"), null);

		if(excludedCatogoriesIds == null || excludedCatogoriesIds.length == 0){
			return;
		}
