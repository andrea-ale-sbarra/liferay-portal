...
public class CPOptionFacetPortletPreferences {
	...
	public CPOptionFacetPortletPreferences(
	...
	public String getDisplayStyle() {
		return _portletPreferencesHelper.getString(
			CPOptionFacetPortletPreferences.PREFERENCE_KEY_DISPLAY_STYLE,
			"cloud");
	}

	public int getFrequencyThreshold() {
		return _portletPreferencesHelper.getInteger(
			CPOptionFacetPortletPreferences.PREFERENCE_KEY_FREQUENCY_THRESHOLD,
			1);
	}

	public int getMaxTerms() {
		return _portletPreferencesHelper.getInteger(
			CPOptionFacetPortletPreferences.PREFERENCE_KEY_MAX_TERMS, 10);
	}

	public boolean isFrequenciesVisible() {
		return _portletPreferencesHelper.getBoolean(
			CPOptionFacetPortletPreferences.PREFERENCE_KEY_FREQUENCIES_VISIBLE,
			true);
	}
