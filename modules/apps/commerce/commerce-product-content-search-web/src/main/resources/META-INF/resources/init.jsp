...
page import="com.liferay.commerce.product.content.search.web.internal.configuration.CPOptionFacetsPortletInstanceConfiguration" %><%@
...
page import="com.liferay.commerce.product.content.search.web.internal.portlet.CPOptionFacetPortletPreferences" %><%@
page import="com.liferay.commerce.product.content.search.web.internal.portlet.CPSearchResultsPortlet" %><%@
page import="com.liferay.commerce.product.content.search.web.internal.util.PortletPreferencesJspUtil" %><%@
