...
@Component(
	enabled = false,
	property = "dto.class.name=com.liferay.headless.commerce.delivery.order.dto.v1_0.OrderItem",
...
public class OrderItemDTOConverter
	...
	public OrderItem toDTO(DTOConverterContext dtoConverterContext)
		...
		OrderItemDTOConverterContext orderItemDTOConverterContext =
			(OrderItemDTOConverterContext)dtoConverterContext;

		CommerceOrderItem commerceOrderItem =
			_commerceOrderItemService.getCommerceOrderItem(
				(Long)orderItemDTOConverterContext.getId());

		Locale locale = orderItemDTOConverterContext.getLocale();
		...
		return new OrderItem() {
			{
				adaptiveMediaImageHTMLTag =
					_cpInstanceHelper.getCPInstanceAdaptiveMediaImageHTMLTag(
						orderItemDTOConverterContext.getAccountId(),
