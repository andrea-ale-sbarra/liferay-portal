...
@Component(
	enabled = false,
	property = "resource.locator.key=/headless-commerce-admin-account/v1.0/AccountChannelEntry",
	service = AccountChannelEntryResource.Factory.class
)
@Generated("")
public class AccountChannelEntryResourceFactoryImpl
	implements AccountChannelEntryResource.Factory {

	@Override
	public AccountChannelEntryResource.Builder create() {
		return new AccountChannelEntryResource.Builder() {
			...
			public AccountChannelEntryResource build() {
				...
				return _accountChannelEntryResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountChannelEntryResource.Builder checkPermissions(
			...
			@Override
			public AccountChannelEntryResource.Builder httpServletRequest(
			...
			@Override
			public AccountChannelEntryResource.Builder httpServletResponse(
			...
			@Override
			public AccountChannelEntryResource.Builder preferredLocale(
			...
			@Override
			public AccountChannelEntryResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, AccountChannelEntryResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AccountChannelEntryResource.class.getClassLoader(),
			AccountChannelEntryResource.class);

		try {
			Constructor<AccountChannelEntryResource> constructor =
				(Constructor<AccountChannelEntryResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(accountChannelEntryResource);
	...
	private static final Function
		<InvocationHandler, AccountChannelEntryResource>
			_accountChannelEntryResourceProxyProviderFunction =
				_getProxyProviderFunction();
