...
public class ProductVirtualSettingsDTOConverter
	...
	public ProductVirtualSettings toDTO(DTOConverterContext dtoConverterContext)
		...
		List<CPDVirtualSettingFileEntry> cpdVirtualSettingFileEntries = cpDefinitionVirtualSetting.getCPDVirtualSettingFileEntries();

		CPDVirtualSettingFileEntry cpdVirtualSettingFileEntry = cpdVirtualSettingFileEntries.get(0);
		...
		return new ProductVirtualSettings() {
			{
				...
				setProductVirtualSettingsFileEntries(_toProductVirtualSettingsFileEntries(cpdVirtualSettingFileEntries, cpDefinition));
				setUrl( () -> {
	...
	private ProductVirtualSettingsFileEntry[] _toProductVirtualSettingsFileEntries(List<CPDVirtualSettingFileEntry> cpdVirtualSettingFileEntries, CPDefinition cpDefinition) {
		return TransformUtil.transformToArray(cpdVirtualSettingFileEntries,
				cpdVirtualSettingFileEntry -> new ProductVirtualSettingsFileEntry() {{
					setUrl( () -> {
						if (Validator.isNull(cpdVirtualSettingFileEntry.getUrl())) {
							return null;
						}
					...
					setVersion( () -> {
						if (Validator.isNull(cpdVirtualSettingFileEntry.getVersion())) {
							return null;
						}
