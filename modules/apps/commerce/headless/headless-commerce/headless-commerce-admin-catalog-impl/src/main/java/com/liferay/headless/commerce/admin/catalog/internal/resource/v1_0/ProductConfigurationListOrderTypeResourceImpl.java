...
public class ProductConfigurationListOrderTypeResourceImpl
	...
	public Page<ProductConfigurationListOrderType>
		...
		return Page.of(
			_toProductConfigurationListOrderTypes(cpConfigurationListRels),
	...
	public ProductConfigurationListOrderType
		...
		CPConfigurationListRel cpConfigurationListRel =
			_addCPConfigurationListRel(
				cpConfigurationList, productConfigurationListOrderType);
	...
	private List<ProductConfigurationListOrderType>
		...
		List<ProductConfigurationListOrderType>
			productConfigurationListOrderTypes = new ArrayList<>();

		for (CPConfigurationListRel cpConfigurationListRel :
				cpConfigurationListRels) {

			productConfigurationListOrderTypes.add(
				_toProductConfigurationListOrderType(
					cpConfigurationListRel.getCPConfigurationListRelId()));
		}

		return productConfigurationListOrderTypes;
	}
