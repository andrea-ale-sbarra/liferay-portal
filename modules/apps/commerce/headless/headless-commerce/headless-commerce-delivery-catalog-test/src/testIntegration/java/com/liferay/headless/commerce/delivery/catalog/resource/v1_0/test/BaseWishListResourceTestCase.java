...
public abstract class BaseWishListResourceTestCase {
	...
	public void testGetWishList() throws Exception {
		...
		WishList getWishList = wishListResource.getWishList(
			testGetWishList_getChannelId(), null, postWishList.getId());

		assertEquals(postWishList, getWishList);
		assertValid(getWishList);
	}

	protected Long testGetWishList_getChannelId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
								...
								new HashMap<String, Object>() {
									{
										put(
											"channelId",
											testGraphQLGetWishList_getChannelId());
	...
	protected Long testGraphQLGetWishList_getChannelId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	public void testDeleteWishList() throws Exception {
		...
		assertHttpResponseStatusCode(
			404,
			wishListResource.getWishListHttpResponse(
				testDeleteWishList_getChannelId(),
				testDeleteWishList_getAccountId(), wishList.getId()));

		assertHttpResponseStatusCode(
			404,
			wishListResource.getWishListHttpResponse(
				testDeleteWishList_getChannelId(),
				testDeleteWishList_getAccountId(), 0L));
	}

	protected Long testDeleteWishList_getChannelId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testDeleteWishList_getAccountId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
