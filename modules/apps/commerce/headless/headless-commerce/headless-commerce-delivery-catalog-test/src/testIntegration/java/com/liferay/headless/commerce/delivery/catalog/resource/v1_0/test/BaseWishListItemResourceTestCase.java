...
public abstract class BaseWishListItemResourceTestCase {
	...
	public void testGetWishListItemsPage() throws Exception {
		Long channelId = testGetWishListItemsPage_getChannelId();
		Long irrelevantChannelId =
			testGetWishListItemsPage_getIrrelevantChannelId();
		...
		Page<WishListItem> page = wishListItemResource.getWishListItemsPage(
			channelId, null, wishListId, Pagination.of(1, 10));

		Assert.assertEquals(0, page.getTotalCount());

		if ((irrelevantChannelId != null) && (irrelevantWishListId != null)) {
			WishListItem irrelevantWishListItem =
				testGetWishListItemsPage_addWishListItem(
					irrelevantChannelId, irrelevantWishListId,
					randomIrrelevantWishListItem());

			page = wishListItemResource.getWishListItemsPage(
				irrelevantChannelId, null, irrelevantWishListId,
				Pagination.of(1, 2));
		...
		WishListItem wishListItem1 = testGetWishListItemsPage_addWishListItem(
			channelId, wishListId, randomWishListItem());
	...
	public void testGetWishListItemsPageWithPagination() throws Exception {
		...
		Page<WishListItem> page1 = wishListItemResource.getWishListItemsPage(
			channelId, null, wishListId, Pagination.of(1, 2));
		...
		Page<WishListItem> page2 = wishListItemResource.getWishListItemsPage(
			channelId, null, wishListId, Pagination.of(2, 2));
		...
		Page<WishListItem> page3 = wishListItemResource.getWishListItemsPage(
			channelId, null, wishListId, Pagination.of(1, 3));
	...
	protected WishListItem testGetWishListItemsPage_addWishListItem(
			Long channelId, Long wishListId, WishListItem wishListItem)
		throws Exception {
	...
	protected Long testGetWishListItemsPage_getChannelId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetWishListItemsPage_getIrrelevantChannelId()
		throws Exception {
	...
	public void testGetWishListItem() throws Exception {
		...
		WishListItem getWishListItem = wishListItemResource.getWishListItem(
			testGetWishListItem_getChannelId(), null,
			postWishListItem.getWishListId(), postWishListItem.getId());

		assertEquals(postWishListItem, getWishListItem);
		assertValid(getWishListItem);
	}

	protected Long testGetWishListItem_getChannelId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
								...
								new HashMap<String, Object>() {
									{
										put(
											"channelId",
											testGraphQLGetWishListItem_getChannelId());
										put(
											"wishListId",
	...
	protected Long testGraphQLGetWishListItem_getChannelId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	protected void assertValid(WishListItem wishListItem) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("wishListId", additionalAssertFieldName)) {
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("product", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						wishListItem1.getProduct(),
						wishListItem2.getProduct())) {
			...
			if (Objects.equals("wishListId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						wishListItem1.getWishListId(),
						wishListItem2.getWishListId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("wishListId")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
		...
		return new WishListItem() {
			{
				...
				wishListId = RandomTestUtil.randomLong();
			}
		};
	}
