...
public interface TermResource {
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderExternalReferenceCodeDeliveryTermHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderExternalReferenceCodePaymentTermHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public static class TermResourceImpl implements TermResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/{externalReferenceCode}/delivery-term");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/{externalReferenceCode}/payment-term");
