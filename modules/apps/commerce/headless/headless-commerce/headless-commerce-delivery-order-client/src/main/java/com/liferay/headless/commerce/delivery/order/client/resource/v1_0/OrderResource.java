...
public interface OrderResource {
	...
	public HttpInvoker.HttpResponse getChannelAccountOrdersPageHttpResponse(
			Long accountId, Long channelId, Pagination pagination)
		throws Exception;

	public Order getOrder(Long orderId) throws Exception;

	public HttpInvoker.HttpResponse getOrderHttpResponse(Long orderId)
		throws Exception;

	public String getOrderPaymentURL(Long orderId, String callbackURL)
		throws Exception;

	public HttpInvoker.HttpResponse getOrderPaymentURLHttpResponse(
			Long orderId, String callbackURL)
		throws Exception;
	...
	public static class OrderResourceImpl implements OrderResource {
		...
		public Page<Order> getChannelAccountOrdersPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelAccountOrdersPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/channels/{channelId}/accounts/{accountId}/orders");
		...
		public Order getOrder(Long orderId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getOrderHttpResponse(
				orderId);
		...
		public HttpInvoker.HttpResponse getOrderHttpResponse(Long orderId)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/orders/{orderId}");
		...
		public String getOrderPaymentURL(Long orderId, String callbackURL)
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderPaymentURLHttpResponse(orderId, callbackURL);
		...
		public HttpInvoker.HttpResponse getOrderPaymentURLHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/payment-url");
