...
public abstract class BaseAccountChannelEntryResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		accountChannelEntry.setEntryExternalReferenceCode(regex);
		...
		Assert.assertEquals(
			regex, accountChannelEntry.getEntryExternalReferenceCode());
	}
	...
	protected void assertValid(AccountChannelEntry accountChannelEntry)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"entryExternalReferenceCode", additionalAssertFieldName)) {

				if (accountChannelEntry.getEntryExternalReferenceCode() ==
						null) {
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						accountChannelEntry1.getEntryExternalReferenceCode(),
						accountChannelEntry2.getEntryExternalReferenceCode())) {
			...
			if (Objects.equals("entryId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						accountChannelEntry1.getEntryId(),
						accountChannelEntry2.getEntryId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("entryExternalReferenceCode")) {
			sb.append("'");
			sb.append(
				String.valueOf(
		...
		return new AccountChannelEntry() {
			{
				...
				entryExternalReferenceCode = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
