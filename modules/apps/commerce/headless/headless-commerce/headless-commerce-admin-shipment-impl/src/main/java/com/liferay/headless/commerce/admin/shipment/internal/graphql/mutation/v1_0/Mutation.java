...
public class Mutation {
	...
	@GraphQLField
	public Shipment createShipmentDeliver(
			@GraphQLName("shipmentId") Long shipmentId)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_shipmentResourceComponentServiceObjects,
			this::_populateResourceContext,
			shipmentResource -> shipmentResource.postShipmentDeliver(
				shipmentId));
	}

	@GraphQLField
	public Shipment createShipmentFinishProcessing(
			@GraphQLName("shipmentId") Long shipmentId)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_shipmentResourceComponentServiceObjects,
			this::_populateResourceContext,
			shipmentResource -> shipmentResource.postShipmentFinishProcessing(
				shipmentId));
	}

	@GraphQLField
	public Shipment createShipmentShip(
			@GraphQLName("shipmentId") Long shipmentId)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_shipmentResourceComponentServiceObjects,
			this::_populateResourceContext,
			shipmentResource -> shipmentResource.postShipmentShip(shipmentId));
	}
