...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {shipment(shipmentId: ___){accountId, addressId, carrier, createDate, expectedDate, id, modifiedDate, orderId, shipmentItems, shippingDate, shippingMethodId, shippingOptionName, status, trackingNumber, userName}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {shipmentItem(shipmentItemId: ___){createDate, id, modifiedDate, orderItemId, quantity, shipmentId, userName, warehouseId}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
