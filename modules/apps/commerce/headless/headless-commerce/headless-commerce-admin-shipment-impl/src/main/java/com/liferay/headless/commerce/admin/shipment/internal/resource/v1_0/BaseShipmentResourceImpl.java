...
public abstract class BaseShipmentResourceImpl
	implements ShipmentResource, EntityModelResource,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-shipment/v1.0/shipments' -d $'{"carrier": ___, "expectedDate": ___, "orderId": ___, "shipmentItems": ___, "shippingDate": ___, "trackingNumber": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}' -d $'{"carrier": ___, "expectedDate": ___, "orderId": ___, "shipmentItems": ___, "shippingDate": ___, "trackingNumber": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes({"application/json", "application/xml"})
	@PATCH
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}/deliver'  -u 'test@liferay.com:test'
	 */
	@Override
	@POST
	@Parameters(
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Shipment")})
	public Shipment postShipmentDeliver(
			@NotNull @Parameter(hidden = true) @PathParam("shipmentId") Long
				shipmentId)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}/finish-processing'  -u 'test@liferay.com:test'
	 */
	@Override
	@POST
	@Parameters(
	...
	@Path("/shipments/{shipmentId}/finish-processing")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Shipment")})
	public Shipment postShipmentFinishProcessing(
			@NotNull @Parameter(hidden = true) @PathParam("shipmentId") Long
				shipmentId)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}/ship'  -u 'test@liferay.com:test'
	 */
	@Override
	@POST
	@Parameters(
	...
	@Path("/shipments/{shipmentId}/ship")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Shipment")})
	public Shipment postShipmentShip(
			@NotNull @Parameter(hidden = true) @PathParam("shipmentId") Long
				shipmentId)
		throws Exception {
