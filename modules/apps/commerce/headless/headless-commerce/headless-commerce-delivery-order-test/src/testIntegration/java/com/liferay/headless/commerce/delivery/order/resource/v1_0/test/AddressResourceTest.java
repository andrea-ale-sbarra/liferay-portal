...
import com.liferay.headless.commerce.delivery.order.client.dto.v1_0.Address;
...
public class AddressResourceTest extends BaseAddressResourceTestCase {
	...
	@Override
	protected Address testGetOrderBillingAddres_addAddress() throws Exception {
		return _toAddress(_getCommerceAddress());
	}

	@Override
	protected Long testGetOrderBillingAddres_getOrderId() throws Exception {
		return _getOrderBillingAddres_getOrderId();
	}

	@Override
	protected Address testGetOrderShippingAddres_addAddress() throws Exception {
		return _toAddress(_getCommerceAddress());
	}

	@Override
	protected Long testGetOrderShippingAddres_getOrderId() throws Exception {
		return _getOrderShippingAddres_getOrderId();
	}
	...
	@Override
	protected Long testGraphQLGetOrderBillingAddres_getOrderId()
		throws Exception {
	...
	@Override
	protected Long testGraphQLGetOrderShippingAddres_getOrderId()
		throws Exception {
	...
	private long _getOrderBillingAddres_getOrderId() throws Exception {
	...
	private long _getOrderShippingAddres_getOrderId() throws Exception {
		CommerceOrder commerceOrder = _getCommerceOrder();
