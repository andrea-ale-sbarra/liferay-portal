...
public interface WishListResource {
	...
	public HttpInvoker.HttpResponse getWishListHttpResponse(
	...
	public static class WishListResourceImpl implements WishListResource {
		...
		public WishList patchChannelWishList(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchChannelWishListHttpResponse(
		...
		public HttpInvoker.HttpResponse getWishListHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v1.0/channels/{channelId}/wishlists/{wishListId}");
