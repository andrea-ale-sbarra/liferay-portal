...
public interface WishListItemResource {
	...
	public Page<WishListItem> getWishListItemsPage(
			Long channelId, Long accountId, Long wishListId,
	...
	public static class WishListItemResourceImpl
		...
		public Page<WishListItem> getWishListItemsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getWishListItemsPageHttpResponse(
					channelId, accountId, wishListId, pagination);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v1.0/channels/{channelId}/wishlists/{wishListId}/wishlist-items");
		...
		public HttpInvoker.HttpResponse getWishListItemHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v1.0/channels/{channelId}/wishlists/{wishListId}/wishlist-items/{wishListItemId}");
