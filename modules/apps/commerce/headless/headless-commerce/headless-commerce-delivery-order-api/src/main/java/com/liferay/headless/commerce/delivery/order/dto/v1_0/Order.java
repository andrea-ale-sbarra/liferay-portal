...
public class Order implements Serializable {
	...
	@Schema
	@Valid
	public OrderComment[] getOrderComments() {
		return orderComments;
	}

	public void setOrderComments(OrderComment[] orderComments) {
		this.orderComments = orderComments;
	}

	@JsonIgnore
	public void setOrderComments(
		UnsafeSupplier<OrderComment[], Exception> orderCommentsUnsafeSupplier) {

		try {
			orderComments = orderCommentsUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected OrderComment[] orderComments;
	...
	public String toString() {
		...
		if (orderComments != null) {
			...
			for (int i = 0; i < orderComments.length; i++) {
				sb.append(String.valueOf(orderComments[i]));

				if ((i + 1) < orderComments.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.delivery.order.dto.v1_0.Order",
		name = "x-class-name"
	)
