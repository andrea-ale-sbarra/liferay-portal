 ...
 */
@Generated("")
@GraphQLName("ShipmentInfo")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ShipmentInfo")
public class ShipmentInfo implements Serializable {

	public static ShipmentInfo toDTO(String json) {
		return ObjectMapperUtil.readValue(ShipmentInfo.class, json);
	}

	public static ShipmentInfo unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ShipmentInfo.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.delivery.order.dto.v1_0.ShipmentInfo",
		name = "x-class-name"
	)
