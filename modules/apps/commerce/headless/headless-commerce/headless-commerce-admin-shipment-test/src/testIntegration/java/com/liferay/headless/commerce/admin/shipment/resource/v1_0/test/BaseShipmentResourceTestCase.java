...
public abstract class BaseShipmentResourceTestCase {
	...
	@Test
	public void testPostShipmentDeliver() throws Exception {
		Shipment randomShipment = randomShipment();

		Shipment postShipment = testPostShipmentDeliver_addShipment(
			randomShipment);
	...
	protected Shipment testPostShipmentDeliver_addShipment(Shipment shipment)
		throws Exception {
	...
	@Test
	public void testPostShipmentFinishProcessing() throws Exception {
		Shipment randomShipment = randomShipment();

		Shipment postShipment = testPostShipmentFinishProcessing_addShipment(
			randomShipment);
	...
	protected Shipment testPostShipmentFinishProcessing_addShipment(
			Shipment shipment)
		throws Exception {
	...
	@Test
	public void testPostShipmentShip() throws Exception {
		Shipment randomShipment = randomShipment();

		Shipment postShipment = testPostShipmentShip_addShipment(
			randomShipment);
	...
	protected Shipment testPostShipmentShip_addShipment(Shipment shipment)
		throws Exception {
	...
	protected boolean equals(Shipment shipment1, Shipment shipment2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("addressId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						shipment1.getAddressId(), shipment2.getAddressId())) {
