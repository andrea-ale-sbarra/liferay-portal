...
public interface TermResource {
	...
	public HttpInvoker.HttpResponse
			getCartExternalReferenceCodeDeliveryTermsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getCartExternalReferenceCodePaymentTermsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public static class TermResourceImpl implements TermResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{externalReferenceCode}/delivery-terms");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{externalReferenceCode}/payment-terms");
