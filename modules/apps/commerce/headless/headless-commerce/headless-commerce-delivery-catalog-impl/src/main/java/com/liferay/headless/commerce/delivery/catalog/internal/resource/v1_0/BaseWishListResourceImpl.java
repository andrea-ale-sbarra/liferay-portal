...
public abstract class BaseWishListResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v1.0/channels/{channelId}/wishlists' -d $'{"defaultWishList": ___, "id": ___, "name": ___, "wishListItems": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v1.0/channels/{channelId}/wishlists/{wishListId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{channelId}/wishlists/{wishListId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public void create(
			java.util.Collection<WishList> wishLists,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<java.util.Collection<WishList>,
			 UnsafeConsumer<WishList, Exception>, Exception>
	...
	protected UnsafeBiConsumer
		<java.util.Collection<WishList>, UnsafeConsumer<WishList, Exception>,
