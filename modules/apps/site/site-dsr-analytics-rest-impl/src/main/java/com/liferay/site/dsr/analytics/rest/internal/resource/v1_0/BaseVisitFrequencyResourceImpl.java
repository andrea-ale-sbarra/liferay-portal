...
public abstract class BaseVisitFrequencyResourceImpl
	implements VisitFrequencyResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/visit-frequency'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "VisitFrequency")
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/visit-frequency")
