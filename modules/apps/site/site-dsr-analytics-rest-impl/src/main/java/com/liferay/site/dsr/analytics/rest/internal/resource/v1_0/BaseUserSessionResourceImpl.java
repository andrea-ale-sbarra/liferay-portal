...
public abstract class BaseUserSessionResourceImpl
	implements UserSessionResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/events-by-user-sessions'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "UserSession")}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/events-by-user-sessions")
	...
	public UserSessionsPage getEventsByUserSession(
			...
			@jakarta.ws.rs.QueryParam("entityType")
			String entityType,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	...
	protected String getApplicationPath() {
		return "site-dsr-analytics-rest";
	}
