 ...
 */
@Generated("")
@GraphQLName("DiagramEntry")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DiagramEntry")
public class DiagramEntry implements Serializable {

	public static DiagramEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(DiagramEntry.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof DiagramEntry)) {
			return false;
		}

		DiagramEntry diagramEntry = (DiagramEntry)object;

		return Objects.equals(toString(), diagramEntry.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.shop.by.diagram.dto.v1_0.DiagramEntry",
		name = "x-class-name"
	)
