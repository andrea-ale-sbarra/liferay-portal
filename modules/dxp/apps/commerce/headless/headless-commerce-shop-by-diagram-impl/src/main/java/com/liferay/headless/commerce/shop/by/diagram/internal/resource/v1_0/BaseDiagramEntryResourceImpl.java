...
@Generated("")
@Path("/v1.0")
public abstract class BaseDiagramEntryResourceImpl
	implements DiagramEntryResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<DiagramEntry> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/diagramEntries/{diagramEntryId}'  -u 'test@liferay.com:test'
	 */
	@DELETE
	@Override
	@Parameters(
		value = {@Parameter(in = ParameterIn.PATH, name = "diagramEntryId")}
	)
	@Path("/diagramEntries/{diagramEntryId}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "DiagramEntry")})
	public void deleteDiagramEntry(
			@NotNull @Parameter(hidden = true) @PathParam("diagramEntryId") Long
				diagramEntryId)
		throws Exception {
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/diagramEntries/batch'  -u 'test@liferay.com:test'
	 */
	...
	public Response deleteDiagramEntryBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				DiagramEntry.class.getName(), callbackURL, object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/diagramEntries'  -u 'test@liferay.com:test'
	 */
	@GET
	@Override
	@Parameters(
	...
	@Path(
		"/products/by-externalReferenceCode/{externalReferenceCode}/diagramEntries"
	)
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "DiagramEntry")})
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/products/{productId}/diagramEntries'  -u 'test@liferay.com:test'
	 */
	@GET
	@Override
	@Parameters(
	...
	public void create(
			java.util.Collection<DiagramEntry> diagramEntries,
	...
	public void delete(
		...
		for (DiagramEntry diagramEntry : diagramEntries) {
			deleteDiagramEntry(diagramEntry.getId());
		}
	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseDiagramEntryResourceImpl.class);
