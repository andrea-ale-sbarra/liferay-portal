...
test('LPD-43013 Edit configuration template', async ({
	...
	await commerceAdminProductConfigurationListPage.commerceAvailabilityEstimateIdInput.selectOption(
		'5-7 days'
	);
	await commerceAdminProductConfigurationListPage.CPDefinitionInventoryEngineInput.selectOption(
		'default'
	);
	await commerceAdminProductConfigurationListPage.CPTaxCategoryIdInput.selectOption(
		{label: 'Normal Product'}
	);
	...
	await expect(
		commerceAdminProductConfigurationListPage.commerceAvailabilityEstimateIdInput.locator(
			'option[selected]'
		)
	).toHaveText('5-7 days');
	await expect(
	...
	await expect(
		commerceAdminProductConfigurationListPage.CPTaxCategoryIdInput.locator(
			'option[selected]'
		)
	).toHaveText('Normal Product');
	await expect(
